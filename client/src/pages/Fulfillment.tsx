 ...
 * The Addressers is QuoteMail's print-and-mail fulfillment partner.
 */
...
const TIMELINE = [
  {
    ...
    desc: "You approve the campaign and confirm the address list in QuoteMail.",
    time: "Day 0",
  ...
  },
  {
    ...
    desc: "QuoteMail sends the personalized packet data (address, roof photo, estimate) to The Addressers via secure API.",
    time: "Day 0–1",
  ...
  },
  {
    ...
    desc: "Each 5-page Q Mail packet is printed in full color, folded, and stuffed into a #10 window envelope.",
    time: "Day 1–2",
  ...
  },
  {
    icon: Truck,
    title: "Delivery",
    desc: "Homeowners receive their personalized Q Mail estimate packet. Typical delivery: 3–7 business days.",
    time: "Day 5–9",
...
const SPECS = [
  ...
  { label: "All-in Price", value: "$3.50 per Q Mail" },
      ...
      <div className="bg-white border-b border-slate-100 sticky top-0 z-10">
        <div className="container flex items-center gap-4 h-14">
          ...
          <div className="flex items-center gap-2">
            <Package className="w-4 h-4 text-[oklch(0.55_0.22_264)]" />
            <span className="font-semibold text-[oklch(0.17_0.03_255)] text-sm">Fulfillment</span>
          </div>
      ...
      <div className="container py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm">
            Every Q Mail packet is printed, stuffed, and mailed by The Addressers — our exclusive fulfillment partner. From approved batch to homeowner's mailbox in under 48 hours.
          </p>
        </div>
          ...
          {(["overview", "batches", "vendor"] as const).map(tab => (
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-sm font-medium transition-all duration-150 capitalize ${
                activeTab === tab
                  ? "bg-white text-[oklch(0.17_0.03_255)] shadow-sm"
        ...
        {activeTab === "overview" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <h2 className="font-semibold text-[oklch(0.17_0.03_255)] text-base mb-6">
                    ...
                    <div key={i} className="flex gap-4 relative">
                      ...
                      <div className="flex-1 pt-1">
                        <div className="flex items-center gap-3 mb-0.5">
                          <p className="font-semibold text-[oklch(0.17_0.03_255)] text-sm">{step.title}</p>
            ...
            {/* Specs grid */}
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <h2 className="font-semibold text-[oklch(0.17_0.03_255)] text-base mb-4">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {SPECS.map((spec, i) => (
                  <div key={i} className="flex items-center justify-between py-2 border-b border-slate-50 last:border-0">
                    ...
                    <span className="text-sm font-medium text-[oklch(0.17_0.03_255)]">{spec.value}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Pricing callout */}
            <div className="bg-[oklch(0.17_0.03_255)] rounded-xl p-6 flex items-center gap-6">
              <div className="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center flex-shrink-0">
                <DollarSign className="w-7 h-7 text-white" />
              </div>
              <div className="flex-1">
                <p className="font-display font-bold text-white text-xl mb-1">$3.50 per Q Mail — all-in</p>
              ...
              <Link href="/app">
                <Button className="bg-[oklch(0.55_0.22_264)] hover:bg-[oklch(0.48_0.22_264)] text-white font-semibold flex-shrink-0">
                  Start a Campaign
                ...
                {fulfillmentCampaigns.map(campaign => (
                  <div key={campaign.id} className="bg-white rounded-xl border border-slate-200 p-4 hover:shadow-sm transition-all duration-200">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-[oklch(0.96_0.04_264)] flex items-center justify-center flex-shrink-0">
                        <Package className="w-5 h-5 text-[oklch(0.55_0.22_264)]" />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-0.5">
                          <p className="font-semibold text-[oklch(0.17_0.03_255)] text-sm">{campaign.name}</p>
                    ...
                    {campaign.status === "printing" && (
                      <div className="mt-3 pt-3 border-t border-slate-50">
                        ...
                        <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
                          <div className="h-full bg-[oklch(0.55_0.22_264)] rounded-full w-2/3 animate-pulse" />
                        </div>
                      </div>
                    )}
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="font-display font-bold text-[oklch(0.17_0.03_255)] text-lg">The Addressers</h2>
                  <p className="text-slate-500 text-sm mt-0.5">QuoteMail's exclusive print-and-mail fulfillment partner</p>
                  <div className="flex items-center gap-4 mt-2">
                    <a
                      href="https://www.theaddressers.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 text-xs text-[oklch(0.55_0.22_264)] hover:underline"
                    >
                ...
                {[
                  ...
                  <div key={i} className="bg-slate-50 rounded-xl p-4">
                    <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center mb-3 shadow-sm">
                      <item.icon className="w-4 h-4 text-[oklch(0.55_0.22_264)]" />
                    </div>
                    <p className="font-semibold text-[oklch(0.17_0.03_255)] text-sm mb-1">{item.title}</p>
            ...
            {/* Integration status */}
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <h3 className="font-semibold text-[oklch(0.17_0.03_255)] text-sm mb-4">Integration Status</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between py-2 border-b border-slate-50 last:border-0">
                    <div>
                      <p className="text-sm font-medium text-[oklch(0.17_0.03_255)]">{item.label}</p>
